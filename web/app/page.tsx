...
const PARTNERS: PartnerLayer[] = [
  ...
  },
  {
    ...
    linkText: "ARC TESTNET EXPLORER ↗",
    linkHref: "https://testnet.arcscan.app",
  },
  {
    idx: "03",
    name: "Privy",
    ...
    linkText: "PRIVY DOCUMENTATION ↗",
    linkHref: "https://docs.privy.io",
  },
];
...
const CODE_FILES = [
  {
    ...
    desc: "Custom 1inch Aqua App callback hooking into SwapVM execution",
    lang: "SOL",
    tag: "1INCH AQUA",
    color: "#0891B2",
    bg: "rgba(8, 145, 178, 0.10)",
    url: "https://github.com/anynomousfriend/RouteCO2/blob/main/contracts/src/SkyRouteVault.sol",
  },
  {
    path: "contracts/src/SwapVMRuleEngine.sol",
    desc: "SwapVM kinematic flight efficiency rule evaluation & bytecode verification",
    lang: "SOL",
    tag: "SWAPVM",
    color: "#0891B2",
    bg: "rgba(8, 145, 178, 0.10)",
    url: "https://github.com/anynomousfriend/RouteCO2/blob/main/contracts/src/SwapVMRuleEngine.sol",
  },
  {
    ...
    url: "https://github.com/anynomousfriend/RouteCO2/blob/main/agent/src/icao-engine.ts",
  },
  {
    ...
    color: "#0891B2",
    bg: "rgba(8, 145, 178, 0.10)",
    url: "https://github.com/anynomousfriend/RouteCO2/blob/main/agent/src/swapvm-compiler.ts",
  },
  {
    path: "agent/src/circle-wallet.ts",
    desc: "Circle Developer-Controlled Wallet manager & spend policy bounds",
    lang: "TS",
    tag: "CIRCLE AGENT",
    color: "#F59E0B",
    bg: "rgba(245, 158, 11, 0.10)",
    url: "https://github.com/anynomousfriend/RouteCO2/blob/main/agent/src/circle-wallet.ts",
  },
  {
    path: "agent/src/arc-settler.ts",
    desc: "Arc Testnet native USDC micropayment settler via Circle developer wallets",
    lang: "TS",
    tag: "ARC L1",
    color: "#3ECF8E",
    bg: "rgba(62, 207, 142, 0.12)",
    url: "https://github.com/anynomousfriend/RouteCO2/blob/main/agent/src/arc-settler.ts",
  },
  {
    path: "web/lib/privy-config.ts",
    desc: "Privy passkey onboarding & scoped flight manifest session delegation",
    lang: "TS",
    tag: "PRIVY",
    color: "#3ECF8E",
    bg: "rgba(62, 207, 142, 0.12)",
    url: "https://github.com/anynomousfriend/RouteCO2/blob/main/web/lib/privy-config.ts",
  },
];
