...
contract SkyRouteVault is ISkyRouteVault {
    ...
    /// @param swapVmBytecode Compiled SwapVM fuel-efficiency bytecode
    ...
    /// @notice Internal manifest registration logic with SwapVM bytecode validation
    ...
    /// @param amount Amount in wei / micro-USDC to withdraw
    ...
    /// @notice Callback hook executed by 1inch Aqua Core on token swap
    /// @param tokenIn Input asset
    /// @param amountIn Amount of input token
    /// @param tokenOut Output asset
    /// @param amountOut Amount of output token
    /// @param data Additional arbitrary callback execution data
    function aquaAppSwapCallback(
        ...
        data; // Silence unused warning while preserving calldata ABI
